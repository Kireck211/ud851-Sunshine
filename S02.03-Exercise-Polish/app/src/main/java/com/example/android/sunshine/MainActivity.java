...
public class MainActivity extends AppCompatActivity {
    ...
    private ProgressBar mLoadingWeatherDataProgressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoadingWeatherDataProgressBar = (ProgressBar) findViewById(R.id.pb_loading_weather_data);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mLoadingWeatherDataProgressBar.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            mLoadingWeatherDataProgressBar.setVisibility(View.INVISIBLE);
